...
export const ContractPreview = ({ contract, companyInfo }: { contract: IContractItem; companyInfo: ICompanyInfoItem | null; }) => {
            ...
            >
                <Box sx={{
                    ...
                    <Box sx={{
                        ...
                        <Logo sx={{ height: '35px !important' }} width={70} src={companyInfo?.logo} />
                    </Box>
                    {pageOne()}
