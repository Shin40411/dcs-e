                ...
                <View>
                    <View style={styles.header}>
                        ...
                        <View style={styles.rightHeader}>
                            <Text style={{ fontFamily: 'Niramit-Bold' }}>Mẫu số 02 - TT</Text>
                    ...
                    <View style={{ display: 'flex', justifyContent: 'center', flexDirection: 'row', gap: 10 }}>
                        ...
                        <View style={{ width: '40%', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                            <Text style={styles.contractNumber}>Số HĐ: {data.contractNo}</Text>
                            <Text style={styles.contractNumber}>Số PC: {data.receiptNo}</Text>
                    ...
                    <View style={{ paddingHorizontal: 40, marginTop: 30, marginBottom: 50, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: 200 }}>
                        <Text style={styles.textDefault}>Họ và tên người nhận tiền: {data.payerName ? data.payerName : '....................'}</Text>
                        <Text style={styles.textDefault}>Địa chỉ: {data.address ? data.address : '....................'}</Text>
                        <Text style={styles.textDefault}>Lý do chi: {data.reason ? data.reason : '....................'}</Text>
