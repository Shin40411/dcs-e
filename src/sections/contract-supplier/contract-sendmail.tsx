...
export default function ContractSendMail({ openSendMail, email, contract, currentContract }: Props) {
    ...
    const onSubmit = async (data: FormValues) => {
        try {
            ...
            await sendEmailSupplierContract({ email: data.email, contract, currentContract });
