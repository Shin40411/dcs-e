...
export function ContractItem({ openDeleteDialog, setId, contract, onViewDetails, onEditing, companyInfoData, sx, ...other }: Props) {
    ...
    return (
        <>
            ...
            >
                ...
                <ContractPreview contract={contract} companyInfo={companyInfoData} />
