...
export function WarehouseImportTable(
    { remainingProductEmpty, remainingProduct }:
        {
            remainingProductEmpty: boolean;
            remainingProduct: IWarehouseImportProduct[]
        }) {
    const calcAmount = (item: IWarehouseImportProduct) => {
