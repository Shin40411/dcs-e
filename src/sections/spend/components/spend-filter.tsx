...
type ContractOption = IContractItem | IContractSupplyItem;

export function SpendFilterBar({ onFilterChange, onSearching, onReset, contractType }: Props) {
    const today = dayjs();
    ...
    const { contracts: customerContracts, contractsLoading: customerContractsLoading } = useGetContracts({
        pageNumber: 1,
        pageSize: 20,
        key: debouncedContractKw,
        enabled: contractType === "Customer"
    });

    const { contracts: supplierContracts, contractsLoading: supplierContractsLoading } = useGetSupplierContracts({
        pageNumber: 1,
        pageSize: 20,
        key: debouncedContractKw,
