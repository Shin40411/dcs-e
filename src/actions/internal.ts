...
import { ReceiptAndSpendCreateDto, ReceiptAndSpendData, ReceiptAndSpendUpdateDto, ResponseInternalList, TransferCreateDto, TransferData } from "src/types/internal";
...
export function useGetInternalReceiptAndSpend({ pageNumber, pageSize, isReceive, enabled, key }: ReceiptProp) {
    let params = '';
    ...
    const memoizedValue = useMemo(
        () => {
            ...
            return {
                ...
                receiptOrSpendDtEmpty: !isLoading && !isValidating && filteredItems.length === 0,
                mutation: mutate
            }
        },
